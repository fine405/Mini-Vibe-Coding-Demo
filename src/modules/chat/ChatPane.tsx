...
function AgentChatPane({
	...
	const renderPromptInput = (prominent = false) => (
		...
		>
			<PromptInput
				className={cn(
					"[&_[data-slot=input-group]]:border-border/70 [&_[data-slot=input-group]]:bg-card/80 [&_[data-slot=input-group]]:shadow-[0_1px_2px_rgba(15,23,42,0.04),0_8px_24px_-18px_rgba(15,23,42,0.12)] [&_[data-slot=input-group]]:transition-[border-color,background-color,box-shadow] [&_[data-slot=input-group]]:duration-200 [&_[data-slot=input-group]]:hover:border-violet-400/30 [&_[data-slot=input-group]]:has-[[data-slot=input-group-control]:focus-visible]:border-violet-400/40 [&_[data-slot=input-group]]:has-[[data-slot=input-group-control]:focus-visible]:ring-2 [&_[data-slot=input-group]]:has-[[data-slot=input-group-control]:focus-visible]:ring-violet-500/5 dark:[&_[data-slot=input-group]]:hover:border-violet-400/30 dark:[&_[data-slot=input-group]]:has-[[data-slot=input-group-control]:focus-visible]:border-violet-400/40 dark:[&_[data-slot=input-group]]:has-[[data-slot=input-group-control]:focus-visible]:ring-violet-400/10",
					prominent
